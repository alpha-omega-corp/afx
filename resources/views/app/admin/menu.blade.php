    ...
    <x-admin :page="$page">
        <x-card :title="__('app.menu')">
            ...
            <div x-data="sort">
                ...
                <ul class="admin-menu" x-sort.ghost="handle">
                    @foreach($sections as $section)

                        <li class="admin-menu__section shadow-lg" x-sort:item="'{{$section->id}}'">

                            <div class="d-flex justify-content-between">
                                <div class="d-flex gap-4">
                                    <span class="sort-handle" x-sort:handle>@svg('heroicon-o-arrows-pointing-out')</span>
